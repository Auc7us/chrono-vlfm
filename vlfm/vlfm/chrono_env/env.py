...
class ChronoEnv:
    ...
    def reset(self):
        ...
        mmesh.LoadWavefrontMesh(
            project_root + '/data/chrono_environment/hm3d_house_2/hm3d_0880.obj', False, True)
        ...
        # Modify this section to play around with the camera parameters for the ablation study
